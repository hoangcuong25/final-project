...
const NavbarUser = () => {
    return (
        <motion.nav
            ...
            className="bg-white shadow-sm border-b border-gray-100 px-6 py-3 flex items-center justify-between sticky top-0 z-50 max-w-[1700px] mx-auto rounded-2xl"
        >
            {/* Logo + Name */}
            <motion.div
                ...
                <SheetContent side="left" className="w-72 px-2.5">
                    ...
                    <div className="mt-6 flex flex-col gap-3">
                        ...
                        >
                            ...
                            <Link href={"/login"} className="text-green-600 text-sm font-medium">Tài khoản</Link>
                        </motion.button>
                        <motion.button
                            whileHover={{ scale: 1.05 }}
