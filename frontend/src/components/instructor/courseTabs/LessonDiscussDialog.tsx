...
interface LessonDiscussDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  lesson: any;
}

const LessonDiscussDialog = ({
  open,
  onOpenChange,
  lesson,
}: LessonDiscussDialogProps) => {
  ...
  const {
    ...
    formatDate,
    refetchQuestions,
  } = useLessonDiscussion(lesson?.id);

  // Ensure questions are fetched when dialog opens
  React.useEffect(() => {
    if (lesson && open) {
      refetchQuestions();
    }
  }, [lesson, open, refetchQuestions]);
                                        ...
                                        >
                                          ...
                                          <div className="flex-1">
                                            <div className="bg-gray-100 p-2 rounded-lg rounded-tl-none">
                                              ...
                                              <p className="text-xs text-gray-700 mt-1 break-words whitespace-pre-wrap">
                                                {reply.content}
                                              </p>
                                            </div>
...
export default LessonDiscussDialog;
